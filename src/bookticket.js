import './stylesheets/bookticket.css';
import {checkifloggedin, signout, gsignin} from './functions'
        ...
        <div className = "mf-container">
            <div className = "mf">
                ...
                <div className = "sel">
                    ...
                    <div>
                        <label>Source</label>
                        <select name="s" id="s" onChange={handleSource} value={source}>
                    ...
                    <select name = "Destination" onChange = {handleDestination} id = "d" value={destination}>
                        {stations.map((station, index) => (
                                <option key={index} value={station}>
                                    {station}
                                </option>
